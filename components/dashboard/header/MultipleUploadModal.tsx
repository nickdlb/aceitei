    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='h-min py-10'>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button onClick={onSeparate} className="flex-1 flex-col justify-start h-full items-center gap-4 p-4 border-2 border-accinzafraco rounded-lg hover:border-acazul hover:bg-acazul transition-colors text-acbgpreto group">
          ...
          <Button onClick={onCombine} className="flex-1 h-full flex-col justify-start items-center gap-4 p-4 border-2 border-accinzafraco rounded-lg text-acpreto hover:border-acazul hover:bg-acazul transition-colors group">
