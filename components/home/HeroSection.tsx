export default function HeroSection() {
    return (
        <section className="py-20 overflow-hidden h-[85vh] flex items-center justify-start bg-[linear-gradient(180deg,_#F5F5F700_40%,_#FFFFFF_100%),url('/bg_img.png')] bg-repeat bg-[length:200px]">
        <div className="max-w-[1400px] w-full mx-auto flex flex-col lg:flex-row items-center justify-between">
          {/* Texto à esquerda */}
          <div className="max-w-xl text-center lg:text-left">
            ...
            <div className="mt-6 flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <button className="flex items-center gap-2 border border-acazul text-acazul px-5 py-3 rounded-full hover:bg-acazul/10 transition">
                Inscreva-se <span className="text-xl">→</span>
              </button>
            </div>
          </div>
  
          {/* Formulário à direita */}
          <div className="bg-acbranco rounded-xl shadow-lg p-6 w-full mt-12 lg:mt-0 max-w-[600px]">
            ...
            <form className="space-y-4">
              <input
                type="text"
                placeholder="Nome"
                className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-acazul"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <button
                type="submit"
                className="w-full bg-acazul text-acbranco py-2 rounded hover:bg-acazul/80 transition"
              >
                Entrar
              </button>
            </form>
