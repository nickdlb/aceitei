...
export const updatePinPosition = async (pinId: string, xPercent: number, yPercent: number, pins: Pin[], setPins: Dispatch<SetStateAction<Pin[]>>, loadComments: () => Promise<void>) => {
    try {
